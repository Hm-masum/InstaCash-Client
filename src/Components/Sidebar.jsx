...
const Sidebar = () => {
  ...
  const [role] = useRoles();
  const [myTransactionReq, ,] = useMyTransactionReq();
    ...
    <>
      ...
      >
        <div>
          ...
          {/* Nav Items */}
          <div className="flex flex-col justify-between flex-1 mt-6 text-sm">
            <nav>
              {role === "admin" && (
                <NavLink
              ...
              {role === "agent" && (
                ...
                >
                  ...
                  <div className="badge bg-purple-700 text-white">
